...
# CORRECCIÓN: 'import pandas as pd' eliminado del nivel de módulo.
# Pandas no está en la lista de librerías permitidas por el instructivo.
# Se movió el import dentro de ejecutar_experimentos(), única función que lo usa,
# y que nunca es llamada por Gradescope.
...
class Schedulling:
    ...
    def ejecutar_experimentos(self):
        """No modificar."""
        # CORRECCIÓN: import movido aquí para no romper Gradescope si pandas no está instalado
        import pandas as pd
